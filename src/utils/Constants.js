...
const createdByNameTypes = [
  { value: "1", label: "John Doe" },
  { value: "2", label: "Joe Marry" },
  { value: "3", label: "Jane Pope" },
  { value: "4", label: "Steve Smith" },
];
const clientTypes = [
  { value: "1", label: "Gov" },
...
const RQ = {
  ...
  allLeads: "allLeads",
  allPhoneCall: "allPhoneCall",
  allTask: "allTask",
  allEvent: "allEvent",
  leadPhoneCallHighlights: "leadPhoneCallHighlights",
  leadTaskHighlights: "leadTaskHighlights",
  leadEventHighlights: "leadEventHighlights",
  allActivity: "allActivity",
  allRecentLeadData: "allRecentLeadData",
  allPrimarySubsidiary: "allPrimarySubsidiary",
  allEnquiryBy: "allEnquiryBy",
  allClientType: "allClientType",
  allSegment: "allSegment",
  allDivision: "allDivision",
  allRequirement: "allRequirement",
...
const urls = {
  ...
  activityAdd: `${ws}/activity/add`,
  directCallAdd: `${ws}/lead/direct-call/add`,
  emailAdd: `${ws}/lead/email/add`,
  socialmediaAdd: `${ws}/lead/socialmedia/add`,
