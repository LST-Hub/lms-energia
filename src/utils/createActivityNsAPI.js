...
// };
// RestLet API
const getAllPhoneCallActivityRestletScriptDeploymentId = async () => {
  try {
    const body = {
      resttype: "Search",
...
const getAllEventActivityRestletScriptDeploymentId = async () => {
  try {
    const body = {
      resttype: "Search",
...
const getAllTaskActivityRestletScriptDeploymentId = async () => {
  try {
    const body = {
      resttype: "Search",
      recordtype: "task",
