...
const getLocationRestletScriptDeploymentId = async (query) => {
  try {
    const authentication = {
      authentication_code: authentication_code,
      account: accountId,
    ...
    console.log("getLocationRestletScriptDeploymentId error =>", error);
    return {
      success: false,
      message: "Error while fetching restlet script deployment.",
    };
...
export {
  ...
  getLocationRestletScriptDeploymentId,
