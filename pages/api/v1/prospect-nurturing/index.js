...
import {  getProspectNurturingRestletScriptDeploymentId} from "../../../../src/utils/NsAPIcal";
...
export default async function handler(req, res) {
  try {
    if (req.method === "GET") {
      ...
      const prospectNurturingnData = await getProspectNurturingRestletScriptDeploymentId(query);
      response({
        res,
        success: true,
        status_code: 200,
        data: prospectNurturingnData,
