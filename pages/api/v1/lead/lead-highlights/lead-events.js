import { getEventDataActivityRestletScriptDeploymentId } from "../../../../../src/utils/allActivityNsAPI";
...
export default async function handler(req, res) {
  try {
    ...
    if (req.method === "GET") {
      ...
      const allEventActivityData =
        await getEventDataActivityRestletScriptDeploymentId(lid);
        // const formattedEventData = allEventActivityData.list.map(
        //   (item) => item.values
        // );
