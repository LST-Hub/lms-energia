...
import { allTimesheetsSelectSome, maxTake, timesheetReportSelectSome } from "../../../../lib/constants";
...
export default async function handler(req, res) {
  try {
    ...
    if (req.method === "GET") {
      const { createdById, projectId, startDate, endDate } = req.query;
        ...
        switch (restrictionId) {
          case roleRestrictionIds.own:
            timesheet = await prisma.timesheet.findMany({
              ...
              take: maxTake,
              select: allTimesheetsSelectSome,
            });
            break;
