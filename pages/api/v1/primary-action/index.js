...
import { getPrimaryActionRestletScriptDeploymentId} from "../../../../src/utils/NsAPIcal";

export default async function handler(req, res) {
  try {
    if (req.method === "GET") {
      const query = `SELECT id, name FROM CUSTOMLIST_LMS_PRIMARY_ACTION WHERE isinactive='F'`;
      ...
      const primaryActionData = await getPrimaryActionRestletScriptDeploymentId(query);
      response({
        res,
        success: true,
        status_code: 200,
